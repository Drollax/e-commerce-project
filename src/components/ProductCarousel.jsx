    ...
    <section className="bg-primary-green overflow-hidden font-montserrat">
      ...
      >
        <Carousel.Item>
          ...
          <div className="relative min-h-[80vh] lg:min-h-[710px] grid grid-cols-1 lg:grid-cols-2 items-center max-w-[1050px] mx-auto px-8 pt-50 lg:!px-0">
            
            <div className="flex flex-col text-left items-start text-white z-10 pt-20 lg:!pt-0 lg:!justify-center h-full order-1 max-w-[400px] md:max-w-[600px] mx-auto lg:mx-0">
              <h5 className="uppercase font-bold text-30 !mb-6">
                Summer 2020
              </h5>
              <h1 className="text-h2 md:text-h1 font-bold !mb-8 leading-tight">
              ...
              <div className="!flex !flex-col lg:!flex-row !items-start lg:!items-center !justify-start !gap-8 !mt-4 !w-full">
                <span className="text-h3 font-bold tracking-tight text-white">
                  $16.48
                </span>
